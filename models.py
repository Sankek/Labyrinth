...
pyramid_model = [{'crds': poly_1, 'color': 'red', 'outline': '', 'width': 2},
                 {'crds': poly_2, 'color': 'green', 'outline': '', 'width': 2},
                 {'crds': poly_3, 'color': 'blue', 'outline': '', 'width': 2},
                 {'crds': poly_4, 'color': 'black', 'outline': '', 'width': 2},
                 {'crds': poly_5, 'color': 'grey', 'outline': '', 'width': 2},
...
for crds in wall_list:
    corner_model += [{'crds': crds, 'color': 'yellow', 'outline': '', 'width': 2}]